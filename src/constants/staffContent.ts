...
export const STAFF_PRICE_MAP: Record<string, string> = {
  'Чолпон Кадралиева': 'от 4000 с',
  'Адинай Жапаралиева': 'от 1500 с',
  'Заира Рамзанова': 'от 1800 с',
  'Заира Рамазанова': 'от 1800 с',
  'Асел Молдош': 'от 4000 с',
  'Анна Анастасиади': 'от 3500 с',
  'Наталья Джунковская': 'от 2500 с',
  'Александр Клеваков': 'от 1500 с',
  'Астра Исаева': 'от 2800 с',
  'Виктор Толмасов': 'от 4000 с',
  'Джамиля Абилдаева': 'от 2000 с',
  'Акылай Шамкеева': 'от 2000 с',
  'Жылдыз Мади': 'от 3500 с',
  'Руфина Мажитова': 'от 1500 с',
  'Алина Сасаза': 'от 1800 с',
  'Ксения Антонова': 'от 2500 с',
  'Вера Романенко': 'от 3400 с',
  'Айдана Мадишова': 'от 3000 с',
  'Айдина Ажибаева': 'от 2000 с',
};
...
export const STAFF_EXPERIENCE_MAP: Record<string, string> = {
  ...
  'Ксения Антонова': 'Опыт работы с 2019 года',
