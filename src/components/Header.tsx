        ...
        <nav className="nav container">
            ...
            <div className={`nav__menu ${isMobileMenuOpen ? 'show' : ''}`} id="nav-menu">
                <ul className="nav__list">
                    ...
                    <li className="nav__item"><Link href="/staff" legacyBehavior><a className="nav__link" onClick={closeMobileMenu}>Специалисты</a></Link></li>
                    <li className="nav__item"><a href="#faq" className="nav__link" onClick={closeMobileMenu}>FAQ</a></li>
                </ul>
                <div className="nav__mobile-actions">
                    <Link href="/login" legacyBehavior><a className="btn btn--outline btn--mobile" onClick={closeMobileMenu}>Войти</a></Link>
                    <a href="#" className="btn btn--primary btn--mobile" onClick={closeMobileMenu}>Найти психолога</a>
                </div>
            </div>
