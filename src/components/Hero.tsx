    ...
    <section className="hero hero--chat">
      ...
      <div className="hero__top container">
        ...
        <h1 className="hero__title">
          Найти своего психолога <span className="hero__title-accent">Легко</span>
        </h1>
        <p className="hero__subtitle">
          Не знаете, с чего начать? Расскажите немного о том, что вас беспокоит. Наш помощник Элли поможет понять ваш запрос и предложит психологов, которые работают с такими ситуациями
        </p>
      </div>
